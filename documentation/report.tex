...
Sections~2--5 cover background, methodology, results, and reflections;
Section~6 concludes.
% ──────────────────────────────────────────────────────────────────────────────
\section{Background}
...
No cross-lingual alignment was applied; we rely on the shared multilingual
subword vocabulary as the sole inter-language bridge.
...
boundary and likely underestimates achievable results; class imbalance was
handled via inverse-frequency weighting to preserve all available training
signal.
...
transformer advantage, consistent with \citet{thangaraj2024crosslingual}'s
note that XLM-R's gains require sufficient data to materialise.
...
We were also glad to find that class weighting was critical: without
\texttt{pos\_weight}, transformer models collapsed to all-zero predictions
on minority classes, making results uninterpretable.
